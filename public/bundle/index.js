...
${frame.code}`;
      ...
      function (require, module, exports, __globalThis) {
        ...
        if (passwordDataForm) {
          ...
          passwordDataForm.addEventListener('submit', async (e) => {
            ...
            // AWAIT TO WAIT AND CLEAR FIELDS
        ...
        class AxiosHeaders {
          ...
          set(header, valueOrRewrite, rewrite) {
            ...
            if (
              ...
              (0, _utilsJsDefault.default).isObject(header) &&
              (0, _utilsJsDefault.default).isIterable(header)
            ) {
              let obj = {},
                dest,
                key;
              for (const entry of header) {
                if (!(0, _utilsJsDefault.default).isArray(entry))
                  throw TypeError(
                    'Object iterator must return a key-value pair',
                  );
                obj[(key = entry[0])] = (dest = obj[key])
                  ? (0, _utilsJsDefault.default).isArray(dest)
                    ? [...dest, entry[1]]
                    : [dest, entry[1]]
                  : entry[1];
              }
      ...
      function (require, module, exports, __globalThis) {
        ...
        const displayMap = (locations) => {
          ...
          const map = new mapboxgl.Map({
            container: 'map',
            style: 'mapbox://styles/spalmamasabeu/cmaygpzkc000i01s12ypv0e3o',
            scrollZoom: true,
          });
    ...
    '10tSC': [
      function (require, module, exports, __globalThis) {
        /* eslint-disable */ // const catchAsync = require('../utils/catchAsync');
        var parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js');
        parcelHelpers.defineInteropFlag(exports);
